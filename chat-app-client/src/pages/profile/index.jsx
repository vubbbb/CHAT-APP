      ...
      <div className=" flex flex-col gap-10 w-[80vw] md:w-max">
        ...
        <div className="grid grid-cols-2">
          ...
          >
            ...
            {hovered && (
              <div className="absolute h-32 w-32 md:w-48 md:h-48  flex items-center justify-center bg-black/50 ring-fuchsia-50 rounded-full">
                {image ? (
        ...
        <div className="w-full">
          <Button className="h-16 w-full bg-purple-500 hover:bg-purple-900 cursor-pointer transition-all duration-300 text-lg" onClick={saveChanges}>
            Save Changes
          </Button>
        </div>
      </div>
